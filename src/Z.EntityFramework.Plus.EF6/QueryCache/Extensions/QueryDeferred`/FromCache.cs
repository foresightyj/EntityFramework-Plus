...
namespace Z.EntityFramework.Plus
{
    public static partial class QueryCacheExtensions
    {
        ...
        public static T FromCache<T>(this QueryDeferred<T> query, CacheItemPolicy policy, string firstTag, params string[] tags)
        {
        ...
        /// </param>
        /// <returns> The result of the query. </returns>
        public static T FromCache<T>(this QueryDeferred<T> query, DateTimeOffset absoluteExpiration, string firstTag, params string[] tags)
        {
            tags = TagsHelper.JoinFirstTagAndRestTags(firstTag, tags);
        ...
        /// </param>
        /// <returns> The result of the query. </returns>
        public static T FromCache<T>(this QueryDeferred<T> query, string firstTag, params string[] tags)
        {
